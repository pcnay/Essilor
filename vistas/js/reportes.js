...
// Imprimir los articulos por Almacen.
$(".btnImpProdAlm").click(function(){
	...
	window.open("extensiones/fpdf186/reportes/rep_por_alm.php?num_AlmImp="+Select.value,"_blank");
...
$(".btnImpTelAsig").click(function(){
	window.open("extensiones/fpdf186/reportes/rep_tel_asig.php","_blank");
...
$(".btnExistenciaPerif").click(function(){
	window.open("extensiones/fpdf186/reportes/rep_exist_perif.php","_blank");
...
// Abrir en una ventana, que contiene la carpeta de la extension PDF.
//window.open("extensiones/tcpdf/pdf/imp_responsiva.php?idResponsiva="+id_Responsiva,"_blank");
window.open("extensiones/fpdf186/reportes/rep_perif_linea.php?num_Linea="+Select.value,"_blank");
...
//	window.location = "index.php?ruta=reportes&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
	...
	window.open("extensiones/fpdf186/reportes/rep_finanzas.php?ruta=rep_finanzas&fechaInic="+Fecha_Inicial+"&fechaFin="+Fecha_Final,"_blank");
...
$(".btnRep_Finanzas_Excel").click(function(){
	...
	window.open("extensiones/fpdf186/reportes/rep-finanz-excel.php?rep_finanzas.php&fechaInic="+Fecha_Inicial.value+"&fechaFin="+Fecha_Final.value,"_blank");
	...
	$(".btnEpo_Danado").click(function(){
		...
		//window.open("extensiones/tcpdf/pdf/imp_responsiva.php?idResponsiva="+id_Responsiva,"_blank");
		// window.open("extensiones/tcpdf/pdf/rep_epos_prestados.php","_blank");
		window.open("extensiones/fpdf186/reportes/rep-epodanado.php","_blank");
