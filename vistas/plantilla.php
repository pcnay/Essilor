  ...
  <?php
    ...
    if (isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok")
    {
      ...
      echo '<div class="wrapper">';
        ...
        {
					//print_r($_GET["ruta"]);
          if ($_GET["ruta"]=="inicio" || $_GET["ruta"]=="usuarios" || $_GET["ruta"]=="perifericos" || $_GET["ruta"]=="tareas" || $_GET["ruta"]=="productos" || $_GET["ruta"]=="prod-gral" || $_GET["ruta"]=="prod-tel" || $_GET["ruta"]=="prod-prod" || $_GET["ruta"]=="clientes"|| $_GET["ruta"]=="responsivas" || $_GET["ruta"]=="cap-responsiva" || $_GET["ruta"]=="editar-responsiva" || $_GET["ruta"]=="crear-venta" || $_GET["ruta"]=="marcas" || $_GET["ruta"]=="linea" ||  $_GET["ruta"]=="Modelos" || $_GET["ruta"]=="ubicaciones" ||  $_GET["ruta"]=="supervisores" || $_GET["ruta"]=="puestos" || $_GET["ruta"]=="deptos" || $_GET["ruta"]=="empleados" || $_GET["ruta"]=="reportes" || $_GET["ruta"]=="respaldo_bd" || $_GET["ruta"]=="edo-epo" || $_GET["ruta"]=="almacen" || $_GET["ruta"]=="cintas"|| $_GET["ruta"]=="centro-costos" || $_GET["ruta"]=="telefonia" || $_GET["ruta"]=="plan-telefonia"  || $_GET["ruta"]=="subir_cintas" || $_GET["ruta"]=="inv_it" || $_GET["ruta"]=="act_producto" || $_GET["ruta"]=="emp_jabil" || $_GET["ruta"]=="importar_cintas" || $_GET["ruta"]=="cap-rap-prod" || $_GET["ruta"]=="notas" || $_GET["ruta"]=="salir" )
          {						
