...
CREATE DATABASE IF NOT EXISTS bd_essilor;
...
CREATE USER 'usuario_essilor'@'localhost' IDENTIFIED BY 'essilor-Mar-04-2020';
GRANT ALL on bd_essilor.* to 'usuario_essilor'  IDENTIFIED BY 'essilor-Mar-04-2020';
*/
